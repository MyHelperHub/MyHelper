<template>
    <div class="MochiBox" :class="[shibaAttribute, { pop: popRef }]" tabindex="0">
        <MochiShiba :size="size" :mood="moodAttribute" :leftEye="leftEyeAttribute" :rightEye="rightEyeAttribute"
            :leftEar="leftEarAttribute" :rightEar="rightEarAttribute" :blush="blushAttribute" />
...
const { shiba, size, mood, leftEye, rightEye, leftEar, rightEar, blush, pop } = defineProps({
    shiba: {
        type: String, default: "okaka"
    },
    size: {
...
const randomize = () => {
    ...
    if (canRandom.value) {
        shibaAttribute.value = [
            "ume", "sesame", "tuna", "okaka", "anko", "kinako", "sakura", "monaka"
        ][Math.floor(Math.random() * 8)];
        moodAttribute.value = [
            "", "happy", "content", "excited", "cheeky", "drool", "cute", "gleam"
        ][Math.floor(Math.random() * 8)];
        leftEyeAttribute.value = ["open", "wink", "shy", "laugh"][Math.floor(Math.random() * 4)];
        rightEyeAttribute.value = ["open", "wink", "shy", "laugh"][Math.floor(Math.random() * 4)];
        leftEarAttribute.value = ["up", "down", "flat", "middle"][Math.floor(Math.random() * 4)];
        rightEarAttribute.value = ["up", "down", "flat", "middle"][Math.floor(Math.random() * 4)];
...
// Watch for changes in the "shiba" prop and set canRandom accordingly
