...
const shibaProps = reactive(props);

// Computed properties
const ears = computed(() => {
  let l = "l4";
  let r = "r4";
  if (shibaProps.leftEar === "up") {
    l = "l1";
  } else if (shibaProps.leftEar === "down") {
    l = "l3";
  } else if (shibaProps.leftEar === "flat") {
    l = "l2";
  }
  if (shibaProps.rightEar === "up") {
    r = "r1";
  } else if (shibaProps.rightEar === "down") {
    r = "r3";
  } else if (shibaProps.rightEar === "flat") {
    r = "r2";
  }
  return `/ ears ${l} ${r}`;
});
...
const cheeks = computed(() => {
  return shibaProps.blush ? "/ blush" : "";
});

const styleClass = computed(() => {
  return `${shibaProps.size} / ${shibaProps.mood} ${eyes.value} ${ears.value} ${cheeks.value}`;
});
</script>
